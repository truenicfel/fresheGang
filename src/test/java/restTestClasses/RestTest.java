...
public class RestTest {
    ...
    public void createFilledPseudoDatabase() {
    	...
    	final boolean got = !db.getBooks().isEmpty() && !db.getDiscs().isEmpty();
    ...
    public void emptyDatabaseGetBook() throws IOException {
    	// specify expected
    	final String expected = "{\"Message\":\"OK. The book with isbn-number 12345-322 could not be found!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":200}";
    	// send request and receive answer
    ...
    public void emptyDatabaseGetDisc() throws IOException {
    	// specify expected
    	final String expected = "{\"Message\":\"OK. The disc with barcode 123-45 could not be found!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":200}";
    	// send request and receive answer
    ...
    public void filledDatabaseEditBookNoIsbn() throws IOException {
    	// specify expected
    	final String expected = "{\"Message\":\"Bad Request. The isbn-number must not be emty!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":400}";
    	// send request and receive answer
    	sendAndReceive("POST", "books", "", "{\"title\":\"The Lord of the Rings 2\",\"author\":\"Tolkien\",\"isbn\":\"12345-322\",\"year\":1}");
    	final String got = sendAndReceive("PUT", "books", "", "{\"year\":2000}");
    	// assert equals
    	assertEquals(expected, got);
    }
    ...
    public void filledDatabaseEditDiscNoBarcode() throws IOException {
    	// specify expected
    	final String expected = "{\"Message\":\"Bad Request. The barcode must not be emty!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":400}";
    	// send request and receive answer
    	sendAndReceive("POST", "discs", "", "{\"title\":\"Harry Potter\",\"barcode\":\"123-45\",\"year\":2004,\"fsk\":12,\"director\":\"Director1\",\"writer\":\"Writer1\"}");
    	final String got = sendAndReceive("PUT", "discs", "", "{\"year\":2000}");
    	// assert equals
    	assertEquals(expected, got);
    }
    ...
    public void noBarcodeFoundWhenAddingDisc() throws IOException {
        // specify expected
    	final String expected = "{\"Message\":\"Policy Not Fulfilled. The disc and its barcode/director/writer/title must not be null or empty!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":420}";
        // send request and receive answer
        final String got = sendAndReceive("POST", "discs", "", "{\"title\":\"Harry Potter\",\"year\":2004,\"fsk\":12,\"director\":\"Director1\",\"writer\":\"Writer1\"}");
        // assert equals
        assertEquals(expected, got);
    }
    ...
    public void noDirectorFoundWhenAddingDisc() throws IOException {
    	...
    	final String expected = "{\"Message\":\"Policy Not Fulfilled. The disc and its barcode/director/writer/title must not be null or empty!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":420}";
    	// send request and receive answer
    	final String got = sendAndReceive("POST", "discs", "", "{\"title\":\"Harry Potter\",\"barcode\":\"123-45\",\"year\":2004,\"fsk\":12,\"writer\":\"Writer1\"}");
    	// assert equals
    	assertEquals(expected, got);
    }
    ...
    public void noWriterFoundWhenAddingDisc() throws IOException {
    	...
    	final String expected = "{\"Message\":\"Policy Not Fulfilled. The disc and its barcode/director/writer/title must not be null or empty!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":420}";
    	// send request and receive answer
    	final String got = sendAndReceive("POST", "discs", "", "{\"title\":\"Harry Potter\",\"barcode\":\"123-45\",\"year\":2004,\"fsk\":12,\"director\":\"Director1\"}");
    	// assert equals
    	assertEquals(expected, got);
    }
    ...
    public void noTitleFoundWhenAddingDisc() throws IOException {
    	...
    	final String expected = "{\"Message\":\"Policy Not Fulfilled. The disc and its barcode/director/writer/title must not be null or empty!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":420}";
    	// send request and receive answer
    	final String got = sendAndReceive("POST", "discs", "", "{\"barcode\":\"123-45\",\"year\":2004,\"fsk\":12,\"director\":\"Director1\",\"writer\":\"Writer1\"}");
    	// assert equals
    	assertEquals(expected, got);
    }
    ...
    public void addingDiscWithAlreadyExistingBarcode() throws IOException {
    	// specify expected
    	final String expected = "{\"Message\":\"Internal Server Error. There was a problem adding the disc!\",\"Resources\":{\"Discs\":[],\"Books\":[]},\"Code\":500}";
    	sendAndReceive("POST", "discs", "", "{\"title\":\"Harry Potter\",\"barcode\":\"123-45\",\"year\":2004,\"fsk\":12,\"director\":\"Director1\",\"writer\":\"Writer1\"}");
    	// send request and receive answer
    	final String got = sendAndReceive("POST", "discs", "", "{\"title\":\"Harry Potter\",\"barcode\":\"123-45\",\"year\":2004,\"fsk\":12,\"director\":\"Director1\",\"writer\":\"Writer1\"}");
    	// assert equals
